...
<footer id="footer" class="clearfix">
    <div class="container-fluid">
        ...
        <?php if(isset($_GET['test2'])): ?>
            <div class="row map-container"><div class="col-xs-12 address-list">
                    <div class="col-md-10 col-md-offset-1">
                        <div class="row">
                            <?php $locations = get_pages(array('post_type' => 'location'));foreach( $locations as $location ) {	?>
                                ...
                                <i class="fa fa-map-marker"></i><p class="location" id="no-link"><?php echo get_the_title($location->ID); ?></p>
                                </div><?php /*</a>*/ ?><?php }; ?>
                        </div>
                    </div>
                </div>
        ...
        <div class="row footer-bar">
            ...
            <?php /* if(!isset($_GET['nav'])): ?><div class="col-lg-3 col-md-3 col-sm-3 col-xs-12"><?php if( bi_option('disable_social_footer') == '1') { ?>
                <div class="social-icons"><?php $social_options = bi_option( 'social_icons' ); ?><?php foreach ( $social_options as $key => $value ) {if ( $value ) { ?><a href="<?php echo $value; ?>" title="<?php echo $key; ?>" target="_blank"><i class="fa fa-<?php echo $key; ?>"></i></a><?php }} ?>
                </div><?php } ?>
                </div><?php endif; */ // End of social links ?>
        </div>
    </div>
    </div>
</footer><a href="tel://<?php echo $PHONE ?>" id="mobile-call-cta">
    <div id="mobile-phone-icon"><i class="fa fa-phone"></i> Call Now</div></a><?php wp_footer(); ?><?php include($_SERVER['DOCUMENT_ROOT'].'/inc/scripts.php'); ?><?php global $learning_center; if(isset($learning_center)){include('inc/scripts2.php');} ?><?php global $custom_post; if(isset($custom_post)) : ?> <script type="text/javascript" src="/public/js/scripts3.min.js"></script></script> <?php endif; ?><?php global $drug_type; if(isset($drug_type)){include('inc/script-drug-type.php');} ?><?php global $custom_post; if(isset($custom_post)){include('inc/post-alt.php');} ?> </body></html>
