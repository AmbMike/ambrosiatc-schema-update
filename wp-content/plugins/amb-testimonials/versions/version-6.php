...
while($query->have_posts()) : $query->the_post();
    ...
    $page_data = array(
        'thumbnail' => (get_field('image')) ? get_field('image')['sizes']['thumbnail'] : '/wp-content/uploads/2016/05/singer-dock-150x150.jpg',
    ...
    $output_html .= <<<EOD
                    ...
                    <div itemscope itemtype="http://schema.org/Review">
                        ...
                        <div class="at1-img-box green" style="background-image:url({$page_data['thumbnail']})">
                        ...
                        <div itemprop="itemReviewed" itemscope itemtype="http://schema.org/Service">
                            <span style="display:none;" itemprop="name">Addiction Treatment Center</span>
                        </div>
...
<?php wp_enqueue_script( 'main.js', plugins_url(PLUGIN_NAME) . '/js/version-square-img.js');